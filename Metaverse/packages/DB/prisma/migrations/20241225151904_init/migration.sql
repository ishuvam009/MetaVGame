...
CREATE TABLE "Avatr" (
    ...
    CONSTRAINT "Avatr_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Avatr_id_key" ON "Avatr"("id");

-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_avatarId_fkey" FOREIGN KEY ("avatarId") REFERENCES "Avatr"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
